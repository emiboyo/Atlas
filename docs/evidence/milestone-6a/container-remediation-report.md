...
| Remediated runtime                    | `62cf21a8719ebb8915b9a4943c613e05bd78f2293dc36cceb5af82418130e6c9` | 79 MB |              170 | 2 Critical, 2 High |

The remediated scan contains only these Critical/High findings, all attributed
to inherited Perl 5.40.1-6:
...
The first test run omitted `ATLAS_TEST_DATABASE_URL`, skipped 43 PostgreSQL
...
rerun used an ephemeral PostgreSQL 16.9 container bound only to
`127.0.0.1:55460`, applied migrations through 0008, passed all 139 tests, and
removed the ephemeral container afterward.
